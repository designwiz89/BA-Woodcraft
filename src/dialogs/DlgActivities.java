 ...
 * @author zamora
 */
public class DlgActivities extends javax.swing.JDialog {
     ...
     */
    public DlgActivities(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlNewUser.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Activity", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
        pnlNewUser.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        txtDescription.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        txtDescription.setToolTipText("Enter Activity Description");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(this.getTitle().equals("Update Activity")){
            try {
                Connection conn = DBConnection.connectDb();
                String sql =    "UPDATE activities SET description='" + txtDescription.getText() + "' " +
                                "WHERE act_id='" + aid + "'";
                System.out.println(sql);
                Statement pst = conn.createStatement();
                pst.execute(sql);
                Utils.showMessage(this, "update");
                BA_Main.showRecords(BA_Main.tblList,BA_Main.QUERIES[2],"activity");
            ...
            try {
                Connection conn = DBConnection.connectDb();
                String sql = "INSERT INTO activities(description) values('" + txtDescription.getText() + "')";
                System.out.println(sql);
                Statement pst = conn.createStatement();
                pst.execute(sql);
                Utils.showMessage(this, "insert");
                BA_Main.showRecords(BA_Main.tblList,BA_Main.QUERIES[2],"activities");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgActivities dialog = new DlgActivities(new javax.swing.JFrame(), true);
