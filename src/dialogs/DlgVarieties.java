 ...
 * @author zamora
 */
public class DlgVarieties extends javax.swing.JDialog {
     ...
     */
    public DlgVarieties(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlNewUser.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Variety", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
        pnlNewUser.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        txtDescription.setFont(new java.awt.Font("Tahoma", 2, 18)); // NOI18N
        txtDescription.setToolTipText("Enter Variety Description");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(this.getTitle().equals("Update Variety")){
            try {
                Connection conn = DBConnection.connectDb();
                String sql =    "UPDATE varieties SET description='" + txtDescription.getText() + "' " +
                                "WHERE var_id='" + vid + "'";
                System.out.println(sql);
                Statement pst = conn.createStatement();
                pst.execute(sql);
                Utils.showMessage(this, "update");
                BA_Main.showRecords(BA_Main.tblList,BA_Main.QUERIES[3],"varieties");
            ...
            try {
                Connection conn = DBConnection.connectDb();
                String sql = "INSERT INTO varieties(description) values('" + txtDescription.getText() + "')";
                System.out.println(sql);
                Statement pst = conn.createStatement();
                pst.execute(sql);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgVarieties dialog = new DlgVarieties(new javax.swing.JFrame(), true);
